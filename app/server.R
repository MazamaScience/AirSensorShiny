  ...
  function(input, output, session) {
    ...
    shiny::observe({
      ...
      if ( active$label == "" ) {
        ...
        shinyjs::hide(id = "isSelected", anim = FALSE)
      }
    ...
    output$isSelected <- shiny::renderUI({"Please Select a Sensor."})
    ...
    # - Latest Data -
    #output$latest_pageTitle <- shiny::renderUI({tags$h4("Latest ", active$latest_label, " Data")})
